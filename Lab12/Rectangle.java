...
public class Rectangle
{
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(rectangle.height, height) == 0 && Double.compare(rectangle.width, width) == 0 && Objects.equals(base, rectangle.base);
    }

    @Override
    public int hashCode() {
        return Objects.hash(height, width, base);
    }
}
