...
public class CritterModel {
    ...
    private Critter makeCritter(Class critter) throws Exception {
        ...
        if (critter.toString().equals("class cseas002.hw3.Bear")) {
            // flip a coin
            ...
            if (move == Critter.Action.LEFT)
               ...
               // if (next.getClass() == Husky)
                ...
                if (inBounds(p2) && grid[p2.x][p2.y] != null
                    ...
                    if (c1.equals("cseas002.hw3.Husky") && !other.toString().equals("h")) //an einai husky kai oxi enos me power 0, tote tha xasei ena power
                        other.lowerPower();
                    else //alliws to husky pethainei kai xanoun ta husky
                    info.remove(other);
